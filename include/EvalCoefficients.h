...
struct EvalCoefficients
{
  ...
  // outpost
  static ScoreType32 knightOutpost_[2][2];
  static ScoreType32 bishopOutpost_[2][2];
  ...
  static ScoreType knightUnderKnightAttackBonus_;
  ...
  static ScoreType32 unprotectedPawn_[8];
