...
namespace NEngine
{
  ...
  int EvalCoefficients::isolatedPawn_{ -15 };
  int EvalCoefficients::backwardPawn_{ -10 };
  int EvalCoefficients::weakHalfopenPawn_{ -10 };
  ...
  // arrays
  int EvalCoefficients::passerPawn_[8] = { 0, 7, 9, 15, 40, 65, 100, 0 };
  int EvalCoefficients::multipasserPawn_[8] = { 0, 2, 2, 3, 5, 12, 20, 0 };
  int EvalCoefficients::passerPawnSc_[8] = { 0, 3, 6, 9, 12, 15, 18, 0 };
  int EvalCoefficients::semipasserPawn_[8] = { 0, 2, 3, 5, 7, 15, 0, 0 };
  int EvalCoefficients::farKingPawn_[8] = { 0, 3, 5, 6, 10, 15, 35, 0 };
  int EvalCoefficients::canpromotePawn_[8] = { 0, 3, 4, 7, 20, 30, 50, 0 };
