...
namespace NEngine
{
  ...
  // material diff
  // opening, endgame
  ScoreType32 EvalCoefficients::doubleBishopBonus_[10] = { {0, 0}, {6, 4}, {8, 10}, {10, 12}, {10, 12}, {10, 12}, {10, 12}, {10, 12}, {10, 12}, {10, 12} };
  ScoreType32 EvalCoefficients::doubleKnightBonus_[10] = { {0, 0}, {5, 5}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7} };
  ScoreType32 EvalCoefficients::twoKnightsBonus_[10] = { {0, 0}, {6, 6}, {8, 8}, {8, 8}, {8, 8}, {8, 8}, {8, 8}, {8, 8}, {8, 8}, {8, 8} };
  ...
  ScoreType32 EvalCoefficients::figureAgainstPawnBonus_[10] = { {0, 0}, {35, 15}, {45, 25}, {50, 25}, {50, 25}, {50, 25}, {50, 25}, {50, 25}, {50, 25}, {50, 25} };
