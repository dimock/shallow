...
namespace NEngine
{
  ...
  // king threat
  int EvalCoefficients::knightChecking_{ 50 };
  int EvalCoefficients::bishopChecking_{ 50 };
  ...
  int EvalCoefficients::twoBishopsBonus_[2][2] = { {10, 60}, {5, 35} };
